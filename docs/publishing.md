...
```bash
go install github.com/jlcsoftgenie/gsx/cmd/gsx@v0.2.8
```

Or depend on the module with:

```bash
go get github.com/jlcsoftgenie/gsx@v0.2.8
```
...
```go
require github.com/jlcsoftgenie/gsx v0.2.8
```
